...
import {
    DatePieces,
    DateRangePieces,
} from "../../shared/interfaces/daterange-picker.interface";
import {
    Bar,
    BarChart,
    CartesianGrid,
...
const FinancialAnalytics = () => {
    ...
    const [calendarValues, setCalendarValues] = useState<DatePieces>([
        new Date(),
        new Date(),
    ]);
    const [top5ServicesByAppointments, setTop5ServicesByAppointments] =
        useState();
    ...
    const callEndpoints = () => {
        ...
        axios_instance()
            .post("/analytics/financial/services", data)
            .then((response) => {
        ...
        return (
            <>
                ...
                <button
                    ...
                    className="rounded bg-slate-600 text-slate-100 p-2 hover:bg-slate-700 mt-2 sm:mt-0"
                >
                    Confirm
                </button>
            </>
                    ...
                    <div className="bg-white p-4 shadow-md">
                        ...
                        >
                            <BarChart
                                width={150}
                                height={40}
                                data={top5ServicesByAppointments}
                            >
                                <Bar
                                    dataKey="amount"
