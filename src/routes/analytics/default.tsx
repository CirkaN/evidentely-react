    ...
    const mutateButtons = () => {
        return (
            <>
                ...
                />
                <button className="rounded bg-slate-600 text-slate-100 p-2 hover:bg-slate-700 ">
                    Confirm
                </button>
            </>
        );
            ...
            <div className="flex flex-wrap justify-evenly">
                ...
                <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 p-4">
                    <p className="text-center font-bold">
                        Your top clients: 2023-10-10 - 2023-11-12
                    </p>
                    <p className="text-center">Filter:</p>
                    <div className="flex  justify-center ">
                        <div>
                            <button
                                onClick={() => setUseProfit(false)}
                                className=" p-2  rounded bg-slate-700 text-slate-100 text-md font-semibold mr-2 "
                            >
                                Appointments
                            </button>
                        </div>
                    ...
                    <ResponsiveContainer width="100%" height="100%" aspect={1}>
                        <BarChart
                            width={150}
                            height={40}
                            data={useProfit === true ? profitData : data2}
                        >
