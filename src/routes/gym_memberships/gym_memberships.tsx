...
const GymMemberships = () => {
    const [createMembershipModalOpen, setCreateMembershipModalOpen] =
        useState(false);
    ...
    const actions: Action<GymMembershipDTO>[] = [
        {
            ...
            fn: (gymMembership: GymMembershipDTO) => {
    ...
    const table_actions: TableAction[] = [
        {
            icon: <Plus />,
            fn: () => {
                setCreateMembershipModalOpen(true);
            },
        },
    ];
    ...
    const deleteMembership = (id: string) => {
        axios_instance()
            .post(`/gym_memberships/${id}/set_inactive`)
            .then(() => {
