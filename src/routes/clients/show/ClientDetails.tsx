...
const ClientDetails = () => {
    ...
    const saveChanges = () => {
        ...
        if (form?.settings) {
            axios_instance()
                .put(`/clients/${id}/settings`, form.settings)
                .catch((e) => {
                    toast.error(e.response.data.message);
                });
        }
            ...
            {somethingChanged && (
                <div className="flex justify-end space-x-4 ">
                    <button
                        ...
                        className="rounded-full hover:bg-green-700 bg-green-500 "
                    >
                        <Check size={50} color="white"></Check>
                    </button>
                    <button
                        onClick={() => {
                            resetChanges();
                        }}
                        className="rounded-full hover:bg-red-700 bg-red-500 "
                    >
                        <X size={50} color="white"></X>
                    </button>
                </div>
            )}
            ...
            <div className="flex justify-between">
                <div>
                    <form className="w-full max-w-lg">
                        <div className="p-5 text-center text-lg block text-gray-800">
                            Izmeni Klijenta
                        </div>
                        ...
                        {form?.settings.receive_sms ? (
                            <div>
                                <div className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow">
                                    ...
                                    <label className="block text-sm font-medium text-gray-600">
                                        Remind day before appointment (24h)
                                    </label>
                                    <Switch
                                        checked={
                                            form?.settings.sms_remind_day_before
                                        }
                                        onCheckedChange={(checked) =>
                                            setForm(
                                                (c) =>
                                    ...
                                    <label className="block text-sm font-medium text-gray-600">
                                        Remind same day when appointment is due
                                        (2h before appointment)
                                    </label>
                                    <Switch
                                        checked={
                                            form?.settings.sms_remind_same_day
                                        }
                                        onCheckedChange={(checked) =>
                                            setForm(
                                                (c) =>
                                    ...
                                    <label className="block text-sm font-medium text-gray-600">
                                        Remind when appointment is created
                                    </label>
                                    <Switch
                                        checked={
                                            form?.settings
                                                .sms_remind_when_appointment_is_created
                                        }
                                        onCheckedChange={(checked) =>
                                            setForm(
                                                (c) =>
                                    ...
                                    />
                                    <label className="block text-sm font-medium text-gray-600">
                                        Send thank you note on appointment end
                                        (30 min after)
                                    </label>
                                    <Switch
                                        checked={
                                            form?.settings
                                                .sms_send_thank_you_note
                                        }
                                        onCheckedChange={(checked) =>
                                            setForm(
                                                (c) =>
