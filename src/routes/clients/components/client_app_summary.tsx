...
const ClientAppointmentSummaryGraph = (props: GraphProps) => {
    ...
    const [labels, setLabels] = useState<Array<number | string>>(['January', 'February', 'March', 'April', 'May', 'June', 'July']);
    ...
    useQuery({
        ...
        queryFn: () => axios_instance().post(`/analytics/user/${props.user_id}/appointments_history`)
