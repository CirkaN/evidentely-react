            ...
            {!isLoading && (
                <div className="flex flex-wrap -mx-2 ">
                    <div className="w-full sm:w-1/2 md:w-1/3 px-2 mb-4  border-2">
                        <div className="bg-white p-4 rounded shadow space-y-2 ">
                            <p className="text-center">
                                {t("sales.summary_this_month")}:
                            </p>
                            <div className="flex justify-between ">
                                <div>
                                    {t("sales.summary_value_sold_this_month")}:
                                </div>
                                <div>
                                    <span className="text-slate-600">
                                        {formatCurrency(
                                            salesStats?.current_month
                                                .total_sold_value,
                                        )}
                                    </span>
                                </div>
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/3 px-2 mb-4 border-2">
                        <div className="bg-white p-4 rounded shadow space-y-2 ">
                            <p className="text-center">
                                {t("sales.summary_pending_sales_this_month")}:
                            </p>
                            <div className="flex justify-between ">
                                <div>
                                    {t(
                                        "sales.summary_total_unpaid_product_value",
                                    )}
                                    :
                                </div>
                                <div>
                            ...
                            <div className="flex justify-between">
                                <div>
                                    {t("sales.summary_total_pending_cost")}:
                                </div>
                                <div>
                                    <span className="text-red-600">
                                        {formatCurrency(
                            ...
                            <div className="flex justify-between">
                                <div>
                                    {t("sales.summary_total_pending_profit")}
                                </div>
                                <div>
                                    <span className="text-green-600">
                                        {formatCurrency(
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/3 px-2 mb-4 border-2">
                        <div className="bg-white p-4 rounded shadow space-y-2 ">
                            <p className="text-center">
                                {t("sales.summary_yearly_statistic")}:
                            </p>
                            <div className="flex justify-between ">
                                <div>
                                    {t(
                                        "sales.summary_total_products_sold_in_value",
                                    )}
                                    :
                                </div>
                                <div>
                            ...
                            <div className="flex justify-between">
                                <div>
                                    {t(
                                        "sales.summary_total_products_sold_cost",
                                    )}
                                    :
                                </div>
                                <div>
