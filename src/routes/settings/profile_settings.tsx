...
const ProfileSettings = () => {
        ...
        setUserSettings(
            (c) =>
                c && {
                    ...
                    user_settings: {
                        ...c.user_settings,
                        email_daily_report: data.email_daily_report,
                    },
                },
        );
        setUserSettings(
    ...
    const saveForm = () => {
        axios_instance()
            .put(`/user_settings/${user?.id}`, userSettings.user_settings)
            .then(() => {
                refreshData();
    ...
    const saveAvatar = () => {
        ...
        axios_instance()
            .post(`user_settings/${user?.id}/avatar`, formData, {
                headers: {
                ...
                <div className="space-y-12">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="border-b border-gray-900/10 pb-12">
                            ...
                            <p className="mt-1 text-sm leading-6 text-gray-600">
                                Molimo unesite tacne informacije kako bi smo
                                mogli da saljemo dnevne / nedeljne / mesecne
                                izvestaje .
                            </p>
                    ...
                    <div className="border-b border-gray-900/10 pb-12">
                        ...
                        <p className="mt-1 text-sm leading-6 text-gray-600">
                            Izaberite vrstu notifikacija koje biste zeleli
                            dobijate na vas e-mail
                        </p>
                                    ...
                                    <div className="mt-6 space-y-6">
                                        <div className="relative flex gap-x-3">
                                            ...
                                            <div className="text-sm leading-6">
                                                ...
                                                <p className="text-gray-500">
                                                    Dobijte besplatan dnevni
                                                    izvestaj na osnovu podataka
                                                    iz aplikacije
                                                    (dugovanja/profit) (13PM).
                                                </p>
                                            </div>
                                        </div>
                                        <div className="relative flex gap-x-3">
                                        ...
                                        <div className="relative flex gap-x-3">
                                            ...
                                            <div className="text-sm leading-6">
                                                ...
                                                <p className="text-gray-500">
                                                    Budite obavesteni o akcijama
                                                    i novinama u softveru.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
