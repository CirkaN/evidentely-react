...
const MyLayout = () => {
    ...
    const navRoutes = [
        {
            ...
            icon: <Grid size={20} />,
            href: "/main_dashboard",
            current: location.pathname == "/main_dashboard",
        },
        {
            ...
            items: [
                {
                    ...
                    current:
                        location.pathname === "/company_settings/sms_settings",
                },
                {
                    name: t("navbar.plans"),
                    icon: <Settings size={20} />,
    ...
    useEffect(() => {
        ...
        setCollapsedMenies(
            (c) =>
                c && {
                    ...c,
                    settings: location.pathname.startsWith("/company_settings"),
                },
        );
                    ...
                    {!e.href && (
                        <>
                            <button
                                onClick={() => {
                                    changeState(
                                        e.key as keyof typeof collapsedMenies,
                                    );
                                }}
                                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            >
                            ...
                            <ul
                                className={`space-y-1 font-medium mx-10 ${
                                    isMenuCollapsed(
                                        e.key as keyof typeof collapsedMenies,
                                    )
                                        ? "block"
 ...
 border-gray-200 dark:bg-gray-800 dark:border-gray-700"
                ...
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start rtl:justify-end">
                            ...
                            <Link
                                className="flex ms-2 md:me-24 dark:hidden"
                                to="/"
                            >
                                <img
                                    src="/moj_biznis_dark.webp"
                                    className="h-8 me-3"
                                    alt="Moj biznis logo"
                                />
                            ...
                            <Link
                                className="flex ms-2 md:me-24 invisible  dark:visible"
                                to="/"
                            >
                                <img
  ...
  bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700 ${
      isNavCollapsed ? "-translate-x-full" : ""
  }`}
                aria-label="Sidebar"
            >
                <div className="flex-row  bg-slate-600 dark:bg-slate-600 py-3 px-5 space-y-2">
                    <div className="flex justify-between w-full py-1">
                        <div>
                            <p className="text-white bg:text-white text-lg">
                                {t("plan_subscription.available_sms")}:
                            </p>
                        </div>
                        <div>
                            <p className="text-white font-bold text-lg">
                                {user?.company.available_sms_to_spend} SMS-a
                            </p>
                        </div>
                    </div>
                    <div className="flex justify-between w-full">
                        <div>
                            <p className="text-white text-lg">
                                {t("plan_subscription.plan")}:
                            </p>
                        </div>
                        <div>
                            <p className="text-white font-bold text-lg">
                                {user?.company.plan_name}
                            </p>
                        </div>
                    </div>
                    <div className="flex justify-between w-full">
